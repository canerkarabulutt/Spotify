...
class SearchResultsViewController: UIViewController {
    ...
    private var sections: [SearcSection] = []
...
extension SearchResultsViewController {
    ...
    func update(with results: [SearchResult]) {
        ...
        self.sections = [
            SearcSection(title: "Songs", results: tracks),
            SearcSection(title: "Artists", results: artists),
            SearcSection(title: "Playlist", results: playlists),
            SearcSection(title: "Albums", results: albums)
        ]
